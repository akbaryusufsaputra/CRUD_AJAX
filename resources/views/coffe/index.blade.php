                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title pull-left">Coffe</h4>
    ...
    <script>
        $(function() {
            ...
            $('body').on('click', '.editItem', function () {
                ...
                $.get("{{ route('coffe.index') }}" +'/' + item_id +'/edit', function (data) {
